...
static void copy_mbr(u8 *disk)
{
	...
	*(unsigned short *)(disk + MBR_SIGNATURE_OFFSET) = MBR_SIGNATURE;
	...
	//Opening file 
	dof_file = filp_open("DiskOnFile.txt",  O_RDWR, 777);

       kernel_write(dof_file,&def_part_table,PARTITION_TABLE_SIZE, PARTITION_TABLE_OFFSET);
...
//Module Information 
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Nishad Sahu <h20160215@pilani.bits-pilani.ac.in>");
